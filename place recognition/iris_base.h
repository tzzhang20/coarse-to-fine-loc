...
public:
    ...
    float Compare(const FeatureDesc &img1, const FeatureDesc &img2, int *bias = nullptr) const;
    ...
    void GetHammingDistance(const cv::Mat1b &T1, const cv::Mat1b &M1, const cv::Mat1b &T2, const cv::Mat1b &M2, int scale, float &dis, int &bias) const;
