...
//Check for intersection among multiple spheres
...
//The implementation of Eq.(20) in the paper
...
//Solving for the initial values s0, the output serves as the input for Eq.(19), (20), and (21).
/*
...
//Iteratively solve the equation system, corresponding to the Eq.(19), (20), and (21) in the paper.
